...
public class Client {
	public static void main(String[] args) {
		try {
			...
			DatagramPacket packet = new DatagramPacket(data, data.length, InetAddress.getByName("192.168.56.2"),
					receiverPort);
					...
					while (true) {
						...
						if (videoImage != null) {
							...
							DatagramPacket videoPacket = new DatagramPacket(data1, data1.length,
									InetAddress.getByName("192.168.56.2"), 9999);
				...
				try {
					...
					while (true) {
						...
						DatagramPacket audioPacket = new DatagramPacket(audioData, numBytesRead,
								InetAddress.getByName("192.168.56.2"), 7777);
