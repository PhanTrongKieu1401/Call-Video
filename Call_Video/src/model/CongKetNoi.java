...
public class CongKetNoi implements Serializable {
	...
	private int  videoSocket, audioSocket, receiveVideoSocket, receiveAudioSocket, stt, informationSocket, shareVideo;
	...
	public void setShareVideo(int shareVideo) {
		this.shareVideo = shareVideo;
	}
